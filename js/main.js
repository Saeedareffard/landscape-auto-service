(function ($) {
  ...
  $("#book-submit-button").click(function () {
    ...
    // );
    $.ajax({
      url: `http://localhost:10000/email?firstName=${firstName}&carName=${carName}&details=${details}&serviceName=${serviceName}&receivingAddress=${emailAddress}&date=${date}&phone=${phone}`,
      data: {},
      type: "GET",
